...
const Notification = () => {
  const { currentColor, closeDropDowns } = useStateContext();

  return (
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <button type='button'  style={{float: 'right'}} onClick={() => closeDropDowns('notification')}><MdOutlineCancel size={30} /></button>
